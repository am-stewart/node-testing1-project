...
function trimProperties(obj) {
  ...
  for (let value in obj) {
    trimmedObj[value] = obj[value].trim();
  }
  return trimmedObj
}
...
function findLargestInteger(integers) {
  let result = integers.sort((a, b) => b.integer - a.integer)
...
class Car {
   ...
   */
  drive(distance) {
    const drivableDistance = this.tank * this.mpg
   ...
   */
  refuel(gallons) {
    const gallonsDifference = this.tankSize - this.tank
    
    if(gallonsDifference > gallons) {
